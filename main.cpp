...
namespace hg {
    ...
    public:
        ...
        void onInit() override {
            ...
            SHADERS.set("test", new ShaderProgram("test", vertex, testFragment));
            SHADERS.set("color", new ShaderProgram("color", vertex, colorFragment));
            SHADERS.set("texture", new ShaderProgram("texture", vertex, textureFragment));
